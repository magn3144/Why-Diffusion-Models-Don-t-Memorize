...
### General options
#BSUB -q gpuv100
#BSUB -J memorization_sprites_loss_and_width_exp
#BSUB -n 12
...
#BSUB -B
#BSUB -N
#BSUB -o batch_output/memorization_sprites_loss_and_width_exp_%J.out
#BSUB -e batch_output/memorization_sprites_loss_and_width_exp_%J.err
